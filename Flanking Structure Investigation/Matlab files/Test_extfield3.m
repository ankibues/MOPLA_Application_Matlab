...
eta= 0:.03:2*pi;
epsilo= 1.6;       % this defines the distance of the marker from the ellipsoidal surface
...
v= VideoWriter('test_Wk=.5_r=10_aspect_.4-.2_lambda_.5-.1-.2_ia_0_marker90.avi');
v.FrameRate =2;
open(v)
writeVideo(v,F)
close(v)
