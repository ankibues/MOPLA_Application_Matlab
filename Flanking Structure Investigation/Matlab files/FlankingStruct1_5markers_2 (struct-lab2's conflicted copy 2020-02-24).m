...
% 3D meshgrid in external coordinate
        xgv     = -3:.03:3;          %-8:.05:8; %:.1:8;           % grid vector: x'axis,a1
...
filename=sprintf('test1_FlankStruct_r=%d_ia%d_AR=%1.1f-%1.1f-%1.1f_Wk=%1.1f_grid3-3_5_markers_fine.avi',r,rad2deg(pp),A(1),A(2),A(3),Wk);
