...
% 3D meshgrid in external coordinate
        xgv     = -1.5:.15:1.5;          %-8:.05:8; %:.1:8;           % grid vector: x'axis,a1
        ...
        xgv_1     = -1.5:.15:1.5;          %-8:.05:8; %:.1:8;           % grid vector: x'axis,a1
        ...
        xgv_2     = -1.5:.03:1.5;          %-8:.05:8; %:.1:8;           % grid vector: x'axis,a1
   ...
   %}
    ...
    %----------------------------
     ...
     %------------------------------------------------------------
        ...
        ygv1    = -1.5:.01:1.5;           % grid vector: y'axis,a2
        zgv1     = -1.5:.01:1.5;  % grid vector: z'axis,a3
       ...
       % plot(XX4,YY4,'.','MarkerSize',2)     % this is for the marker 3 !
        ...
        if rho==2.5
            saveas(f,'rho=2.5_moment.jpg');
        end
        if rho>4.9 && rho < 5 
            saveas(f,'rho=5_moment.jpg');
        end
...
filename=sprintf('FlankStruct_r=%d_ia%d_AR=%1.1f-%1.1f-%1.1f_Wk=%1.1f_Gamma=%1.1f.avi',r,rad2deg(pp),A(1),A(2),A(3),Wk,Gamma);
