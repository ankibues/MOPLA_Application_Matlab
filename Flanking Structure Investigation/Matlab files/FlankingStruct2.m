...
% 3D meshgrid in external coordinate
        xgv     = -3:.02:3;          %-8:.05:8; %:.1:8;           % grid vector: x'axis,a1
        ...
        xgv_1     = -3:.02:3;          %-8:.05:8; %:.1:8;           % grid vector: x'axis,a1
        ...
        xgv_2     = -3:.02:3;          %-8:.05:8; %:.1:8;           % grid vector: x'axis,a1
        ...
        xgv_3     = -3:.02:3;          %-8:.05:8; %:.1:8;           % grid vector: x'axis,a1
        ygv_3     = .8*ones(size(xgv));           % grid vector: y'axis,a2
        ...
        xgv_4     = -3:.02:3;          %-8:.05:8; %:.1:8;           % grid vector: x'axis,a1
        ygv_4     = -.8*ones(size(xgv));           % grid vector: y'axis,a2
...
v= VideoWriter('FlankStruct_r=10_ia0_ar.5-.1_Wk=.8_grid3-3_5_markersgamma2.5_fine.avi');
v.FrameRate =2;
open(v)
writeVideo(v,F)
close(v)
