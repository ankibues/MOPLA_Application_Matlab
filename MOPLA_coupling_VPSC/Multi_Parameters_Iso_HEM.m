function Multi_Parameters_Iso_HEM(Wk,r,a,ang,strI,Nm,Nc,Jd,b)
...
for k=1:steps
   ...
   %---------------------------------------------------------------------------
                                           ...
                                           % temporary work around the bug
                                            ...
                                            fname = sprintf('SS_A_Wk=%2.1f_r=%2.1f_Nm=%d_Nc=%d_shp_%d-%d-%d_IA=%d-%d-%d_gmma=%4.2f_SI=%4.2f.dat',Wk,r,Nm,Nc,AAA(1),AAA(2),AAA(3),ang(1),ang(2),ang(3),Gamma,SI);
                                            
                                            cd 'F:\Dropbox\VPSC_Modeling\Example\pureshear\Iso_dat';
                                            ...
                                            elseif Wk==.50
                                                if r==.5
                                                   fname1= ['F:\Dropbox\VPSC_Modeling\Example\pureshear\Results\IsotropicHEM\Wk=.50\r=.5\' fname];
                                                elseif r==2
                                                   fname1= ['F:\Dropbox\VPSC_Modeling\Example\pureshear\Results\IsotropicHEM\Wk=.50\r=2\' fname];
                                                elseif r==5
                                                   fname1= ['F:\Dropbox\VPSC_Modeling\Example\pureshear\Results\IsotropicHEM\Wk=.50\r=5\' fname];
                                                elseif r==8
                                                   fname1= ['F:\Dropbox\VPSC_Modeling\Example\pureshear\Results\IsotropicHEM\Wk=.50\r=8\' fname];
                                                elseif r==10
                                                   fname1= ['F:\Dropbox\VPSC_Modeling\Example\pureshear\Results\IsotropicHEM\Wk=.50\r=10\' fname];
                                                end
                                            elseif Wk==.75
                                                if r==.5
