...
WK= [1];     %kk1
R=[.5,2,5,10];       %kk2
A1=[5;1;1]; A2=[5;4;1]; A3=[5;3;1];
AA= [A1,A2,A3];          %kk3
ttheta= [0,30,60,90,120,150];    %kk4
strain = [2,4,6,8];
%*************************************************************************
               ...
               for kk3=1:(numel(AA)/3)
                ...
                AAA=a; %noting initial shape;
                        ...
                        for kk4= 1:numel(ttheta)
                            ...
                            fname = sprintf('L_aniso_m=%d_Wk=%2.1f_r=%2.1f_shape_%4.2f-%4.2f-%4.2f_theta=%d_gamma=%4.2f_SI=%4.2f.dat',MM(kk0),Wk,r,AAA(1),AAA(2),AAA(3),ii,Gamma,SI);
                            ...
                            if Wk==0
                                fname1= ['D:\Ankit\Dropbox\VPSC_Modeling\Example\pureshear\Results\Wk=0\' fname];
                            elseif Wk==.5
                                fname1= ['D:\Ankit\Dropbox\VPSC_Modeling\Example\pureshear\Results\Wk=.50\' fname];
                            elseif Wk==.75
                                fname1= ['D:\Ankit\Dropbox\VPSC_Modeling\Example\pureshear\Results\Wk=.75\' fname];
                            elseif Wk==.90
                                fname1= ['D:\Ankit\Dropbox\VPSC_Modeling\Example\pureshear\Results\Wk=.90\' fname];
                            elseif Wk==1
                                fname1= ['D:\Ankit\Dropbox\VPSC_Modeling\Example\pureshear\Results\Wk=1\' fname];
                            end
                                
                                
                            % Plotting the CPO patterns using MTEX toolbox
                            %PlotTexture_AB(fname1);
                            %{
