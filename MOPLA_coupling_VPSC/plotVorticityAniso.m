function plotVorticityAniso(Wk,r,a,ANG,strI,m)
...
% Calculating Far field Stress Invariant for normalization :
   %Cm = C_bar_evl(:,:,:,:,200);      % stiffness tensor for the matrix
          ...
          % far field stress value( sigma= 2*eta*Jd:E)i.e Viscosity(eta)of matrix taken as 1.  
...
% initial state of the ellipsoid
   ...
   ang = ANG*pi/180;                        % See Jiang 2007a for choice of angles.
