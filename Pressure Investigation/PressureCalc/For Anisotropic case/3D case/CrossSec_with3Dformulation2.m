...
%--------------------------------------------------------------------------
 ...
 % 3D meshgrid in clast's coordinate
        xgv     = 0;%0:.05:4;           % grid vector: x'axis,a1
        ygv     = 0:.05:3;           % grid vector: y'axis,a2
        zgv     = 0:.05:2;   % grid vector: z'axis,a3
