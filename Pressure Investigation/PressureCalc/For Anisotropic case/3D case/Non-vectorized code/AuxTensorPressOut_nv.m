function T= AuxTensorPressOut_nv(sub, x,y, a, b, c, d,alp, bet, ww,Cm,psi,ww1)
%nv here means using the non-vectorized version 
% Input: 
...
% tensor(Lambda) for pressure.
  ...
  dp = DP(x,y,alp,bet,Cm,psi,ww1);   % dp is a 3*3*N1 matrix
