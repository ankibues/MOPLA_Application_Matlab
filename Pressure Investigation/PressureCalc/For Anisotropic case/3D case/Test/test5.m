...
%}
     ...
     lambda = solve_eq(a, ep);
        LAMBDA_Ex2= zeros(3,3,length(ep));
        p_Ex2    = zeros(1,length(ep));
 tic
        parfor rr=1:length(ep)
