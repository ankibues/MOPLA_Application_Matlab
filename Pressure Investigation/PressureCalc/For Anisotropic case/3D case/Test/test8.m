...
%
    tic
     ...
     tic
     [m1,n1]= getGaussnodes(1,1,a,ep,Cm);
     toc
     tic
     [m2,n2]= getGaussnodes(1,2,a,ep,Cm);
     toc
     tic
     [m3,n3]= getGaussnodes(1,3,a,ep,Cm);
     toc
     tic
     [m4,n4]= getGaussnodes(2,1,a,ep,Cm);
     toc
     tic
     [m5,n5]= getGaussnodes(2,2,a,ep,Cm);
     toc
     tic
     [m6,n6]= getGaussnodes(2,3,a,ep,Cm);
     toc
     tic
     [m7,n7]= getGaussnodes(3,1,a,ep,Cm);
     toc
     tic
     [m8,n8]= getGaussnodes(3,2,a,ep,Cm);
     toc
     tic
     [m9,n9]= getGaussnodes(3,3,a,ep,Cm);
     toc
     toc
        %}
      %{
